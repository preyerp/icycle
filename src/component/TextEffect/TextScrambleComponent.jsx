...
const Container = styled.div`
  display: flex;
  justify-content: space-between; /* 텍스트를 양 끝과 가운데에 배치 */
  position: absolute;
  width: 100%;
...
function TextScrambleComponent(props) {
  ...
  return (
    <Container>
      ...
      <Text color={color} ref={textRefs[1]} align="center"></Text> {/* 두 번째 텍스트 */}
      <Text color={color} ref={textRefs[2]} align="right"></Text> {/* 세 번째 텍스트 */}
    </Container>
  );
}
